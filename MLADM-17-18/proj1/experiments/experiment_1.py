...
"""
This experimental setting is based on Experiment 1 (Section 6) of https://arxiv.org/abs/1304.8132
It is based on synthetic graph data specifically crafted to confuse the algorithm
"""

#constants for the random graph
CLUSTER_A_SIZE = 300
...
if __name__ == "__main__":
    ...
    for _ in range(10):
        ...
        #Get the most "external" node and the most "internal" node
        max_outer_edges = 0
        max_inner_edges = 0
